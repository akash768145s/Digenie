...
const ContactSection = () => {
  ...
  //   e.preventDefault();
  //   const mailtoLink = `mailto:office@digenie.in?text=Hi Digenie,%0A%0AName: ${encodeURIComponent(
  //     formData.name
  //   )}. ${encodeURIComponent(
  //     formData.subject
  //   )} Here are my details:%0A%0AEmail: ${encodeURIComponent(
  //     formData.email
  //   )}%0APhone:${encodeURIComponent(
  //     formData.phone
  //   )}%0A%0ACan you share more about your process and pricing? Also, can we schedule a call to discuss my requirements?%0A%0AThanks, ${encodeURIComponent(
  //     formData.message
  //   )}`;
      ...
      <section id="contact-form" className="xl:px-48 py-24 bg-[#FBF9F9]">
        ...
        <div className="mx-5 my-10 p-5 lg:p-14 bg-white shadow-sm">
          <form onSubmit={handleSubmit}>
            ...
            <Button className="xl:mx-5 my-5" variant="default">
              Send Message
            </Button>
          </form>
        </div>
